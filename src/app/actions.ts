...
export async function searchInfluencers(
  ...
  if (params.followers_min !== undefined && params.followers_min > 0) query.append("followers_minimum", params.followers_min.toString());
  ...
  if (params.engagement_rate_min !== undefined && params.engagement_rate_min > 0) query.append("engagement_rate_minimum", params.engagement_rate_min.toString());
  ...
  if (params.posts_min !== undefined && params.posts_min > 0) query.append("posts_minimum", params.posts_min.toString());
